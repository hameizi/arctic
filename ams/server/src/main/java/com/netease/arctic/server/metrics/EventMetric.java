...
public class EventMetric  implements MetricsContent<EventMetric> {

  private String tableName = "test_Event_table";
  ...
  public static EventMetric create(Integer metric) {
  ...
  @TaggedMetrics.Metric(name = "eventmetric")
